<script lang="ts">
    ...
    let nutrition: NutritionFactsDTO = getNutritionFactsDTO(recipe);
    ...
    function getNutritionFactsDTO(recipe: RecipeDTO): NutritionFactsDTO | undefined {
...
{#if nutrition }
    ...
    <ul id="{recipeId}-nutrition" class="variante-nutrition">

        <li>Énergie - {nutrition.energy.toFixed(0)} kCal</li>
        <li>Matières Grasses - {nutrition.fat.toFixed(0)} gr</li>
        <li>Glucides - {nutrition.carbs.toFixed(0)} gr</li>
        <li>Protéines - {nutrition.protein.toFixed(0)} gr</li>
        <li>Sel - {nutrition.salt.toFixed(1)} gr</li>
    </ul>
{/if}